...
# 
# #### Percentage of difference to WGS per sample
# ### For the no short spans! 
# # diff_50M_list <- compare_heal_list(dna_ns_cn, sub_50_ns_cn, n_threads = 12, abs=TRUE)
# # diff_perc_50M <- count_non_zero(diff_50M_list)
# # 
# # diff_20M_list <- compare_heal_list(dna_ns_cn, sub_20_ns_cn, n_threads = 12, abs=TRUE)
# # diff_perc_20M <- count_non_zero(diff_20M_list)
# # 
# # diff_wgbs_list <- compare_heal_list(dna_ns_cn, wgbs_ns_cn, n_threads = 12, abs=TRUE)
# # diff_perc_wgbs <- count_non_zero(diff_wgbs_list)
# # 
# # par(mfrow=c(3,1))
# # hist(diff_perc_50M*100, xlim=c(0, 0.2*100), col="orangered", main = "50M", xlab = "Percentage of different bins", cex.main = 2.5, cex.lab = 1.3)
...
# # 
# # 
# # diff_wgbs_no_abs_list <- compare_heal_list(dna_ns_cn, wgbs_ns_cn, n_threads = 12)
# # count_non_zero(diff_wgbs_no_abs_list)
# # diffs_dt <- get_diff_dt(diff_wgbs_no_abs_list)
# # 
# # # par(mfrow = c(4, 3))
...
# wgbs_aln <- get_heal_alignment(wgbs_cn, genespace_dir = "/srv/kenlab/kenji/re_ana_rs7/HEAL/results/genespace/", n_threads = 20)
# # 
# # wgbs_ns_aln <- get_heal_alignment(wgbs_ns_cn, genespace_dir = "/srv/kenlab/kenji/re_ana_rs7/HEAL/results/genespace/", n_threads = 20)
# # ### TRIPLLE CHECK BUT IT SEEMS UNNECESSARY TO REMOVE SHORT SPANS
# #####################
# #####################
# 
# # get summary:
